...
<script type="text/html" data-help-name="function">
    ...
    <p><b>初始化函数</b> 选项卡包含每当节点启动时都会运行的代码。 <b>On Stop</b> 选项卡包含节点停止时将运行的代码。</p>
    <p>如果初始化函数返回的是 Promise 对象，则在解决 Promise 之前节点不会开始处理消息。</p>
    <h3>详细</h3>
    ...
    <p>注意：设置代码在节点初始化期间执行。 因此，如果在设置选项卡中调用<code>node.send</code>，后续节点可能无法接收到该消息。</p>
